      ...
      <article className="my-5 break-inside rounded-md bg-white flex flex-col bg-clip-border shadow-xl text-[#5E5873] h-max w-full sm:w-[90%] mx-auto">
        <div className="flex items-center p-3 justify-between bg-white rounded-t-md">
          <div className="flex">
            <Link className="inline-block" href="#">
              <img
                className="rounded-full max-w-none w-12 h-12 xl:w-16 xl:h-16"
                src={image}
              />
            </Link>
            <div className="flex flex-col mx-2 justify-center">
              <div className="flex">
                ...
                <a
                  className="inline-block lg:text-lg sm:text-sm text-xs font-bold"
                  href="#"
                >
                  {name}
                </a>
        ...
        <div className="">
          <div className="flex justify-center">
            <Link className="flex" href="#">
              ...
              <img className="max-w-full rounded-l-lg" src={picture} />
            </Link>
          </div>
        </div>
        ...
        <div className="p-2 sm:p-4 flex flex-wrap items-center">
          ...
          {tags.map((tag, index) => (
            <div
              key={index}
              className="bg-gray-100 rounded-full px-3 py-1 text-xs font-semibold text-gray-600 mr-2 mb-2"
            >
              {tag}
            </div>
          ))}
