...
class Client(models.Model):
    ...
    current_projects = models.ForeignKey('Project', on_delete=models.SET_NULL, null=True, related_name='current_projects')
...
class Talent(models.Model):
    ...
    currently_working_on = models.ForeignKey('Project', on_delete=models.SET_NULL, null=True, related_name='current_projects')
...
class Mentor(models.Model):
    ...
    currently_mentoring = models.ForeignKey('Project', on_delete=models.SET_NULL, null=True, related_name='current_projects')
