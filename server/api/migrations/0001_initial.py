    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at_time",
                    models.CharField(default="1:08:57 pm", max_length=225, null=True),
                ),
                (
                    "grp_admin",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="9th December 2023 1:08:57 pm",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.FileField(
                        ...
                        default=None,
                        null=True,
                        upload_to=api.models.projects.__prd__file__path__,
                    ),
                ),
                (
                    "Learning_resources",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "learning_resources",
                    models.JSONField(
                        blank=True, default=list, editable=False, null=True
                    ),
                ),
                (
                    "rating",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_by",
                    models.ManyToManyField(
                        null=True, related_name="created_teams", to="api.talent"
                    ),
                ),
                (
                    "members",
                    models.ManyToManyField(
                        related_name="team_members", to="api.talent"
                    ),
                ),
                (
                    "project",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="PRD",
                to="api.projectrequirementdocument",
            ),
        ),
        migrations.AddField(
            model_name="project",
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=api.models.community.__post__path__,
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        null=True,
                        related_name="current_projects_of_mentor",
                        to="api.project",
                    ),
                ),
                (
