...
def store_project_requirement_document_embeddings(prd):
    ...
    metadata = [
        ...
        "project_start_date": project.start_date,
        "project_end_date": project.end_date,
        "project_bid_price": f"{project.bid_price}",
        "project_status": project.status,
        "project_related_techstacks": f"{tuple(project.related_techstacks)}",
        "project_created_at": f"{project.created_at}",
        "project_updated_at": f"{project.updated_at}",
        "project_created_by": f"{project.created_by.user.username}",
        "project_overview": prd.project_overview,
        "original_requirements": prd.original_requirements,
        "project_goals": prd.project_goals,
        "user_stories": prd.user_stories,
